...
from PyQt5.QtWidgets import (
    ...
    QHBoxLayout, QSplitter, QTreeWidget, QTreeWidgetItem, QTextEdit, QComboBox,
...
from constants import DEVICE_PATH_MAP
...
class FileExplorer(QWidget):
    ...
    def send_xbox_toast(self, message):
        if not self.client:
            ...
            return
        try:
            # FAKE TEST ONLY: logs the toast
            self.append_log(f"[TOAST] {message}")
            # To send a real toast, upload and execute a WinRT toast payload
    ...
    def __init__(self):
        ...
        self.host_input = QLineEdit("192.168.137.167")
        self.host_input.setMinimumWidth(150)
        self.host_input.setMaximumWidth(200)
        self.username_input = QLineEdit("app")
        ...
        for mount in DEVICE_PATH_MAP:
            item = QListWidgetItem(self.drive_icon, mount)
